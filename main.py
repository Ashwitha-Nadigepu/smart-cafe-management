...
#images
homeimg= ImageTk.PhotoImage(file="D:/smart-cafe-system-main/images/home.jpg")
logoimg= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/logo.png")
logoimg2= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/logo2.png")
logoimg3= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/logo3.png")
carticon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/cart.png")
contacticon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/comment.png")
abouticon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/info.png")
startimg= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/start.png")
homeicon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/home.png")
cupicon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/offer.png")
accicon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/account.png")
suppicon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/support.png")
logouticon= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/logout.png")
backimg= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/back.png")
product1= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/Black.png")
product2= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/Rist.png")
product3 = ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/ColdBrew1.png")
product4= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/ColdBrew2.png")
product5= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/capp.png")
product6= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/latte.png")
product7= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/espress.png")
product8= ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/mocha.png")
chimg = ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/ch.png")
cartimg = ImageTk.PhotoImage(file="D:\smart-cafe-system-main\images/cart2.png")
aboutimg=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/about.jpg')
c1img=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/c1.png')
c2img=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/c2.png')
pbgimg=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/pbg.png')
ccimg=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/cc.png')
dpimg=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/images.jpeg')
lgimg=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/padlock.png')
ssimg=ImageTk.PhotoImage(file='D:\smart-cafe-system-main\images/ss.png')
#frames
...
def Guest():
    ...
    def save_invoice(text):
        conn = sqlite3.connect("D:/smart-cafe-system-main/database.db")
        cursor=conn.cursor()
    ...
    def developer():
        ...
        backbtn=Button(main,image=backimg,cursor='hand2',activebackground='white',bd=0,command=account,bg='white',highlightthickness=0).place(x=20,y=25)
        label1=Label(main,text='ASHWITHA NADIGEPU',font=("",28,'bold'),bg='white',fg='#3e5348').place(x=600,y=140)
        label1=Label(main,image=ssimg,bg='white').place(x=850,y=540)
        label1=Label(main,text='REG NO : 208R1A6637',font=("",15,'bold'),bg='white').place(x=550,y=330)
        label1=Label(main,text='COURSE : BSc(MSDs)',font=("",15,'bold'),bg='white').place(x=550,y=400)
        label1=Label(main,text='YEAR      : 2nd-YEAR',font=("",15,'bold'),bg='white').place(x=550,y=470)
